...
class Patients(db.Model):
    ...
    sensor_3 = db.Column(db.Integer)
    sensor_4 = db.Column(db.Integer)

    def __repr__(self):
        return f'Patients(id={self.id}, firstname={self.firstname}, lastname={self.lastname}, tag={self.tag}, verzorger_id={self.verzorger_id} sensor_1={self.sensor_1}, sensor_2={self.sensor_2},sensor_3={self.sensor_3},sensor_4={self.sensor_4}'
